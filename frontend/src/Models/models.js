...
export class Espionage extends SLComponent {
    constructor(data) {
...
export class Planet extends SLComponent {
    espionages
...
export class User extends SLComponent {
    planets
...
export class Alliance extends SLComponent {
    members
